plot_n <- function() {
  ...
  # Voltage 
  plot(power_clean_plot$timestamp,power_clean_plot$Voltage,type="l",xlab="datetime",ylab="Voltage")
  ...
  plot(power_clean_plot$timestamp,power_clean_plot$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
